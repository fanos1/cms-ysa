...
<div class="container" style="margin-top: 2em;">	
        <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-12">   
                 <p class="lead">Please fill in the form and click submit. Once we get your request we will call you soon!</p>
                ...
                <form action="" role="form" method="post">
                    ...
                    <div class="form-group">
                      <label for="postcode">Post Code (required). Where do you live</label>
